...
## Statistically significant pairwise differences (DM, 5%): 33 pairs

| Horizon | Pair | DM stat | p |
|---|---|---|---|
| h=2 | SARIMA vs XGBoost | -5.11 | 0.0000 |
| h=3 | ARIMAX vs XGBoost | -30.43 | 0.0000 |
| h=4 | ARIMAX vs XGBoost | -18.22 | 0.0000 |
| h=4 | ARIMA+XGBoost vs XGBoost | -7.72 | 0.0000 |
| h=4 | ARIMA vs SARIMA | -32.71 | 0.0000 |
| h=3 | ARIMA vs RandomForest | -9.25 | 0.0000 |
| h=3 | ARIMA+XGBoost vs XGBoost | -12.36 | 0.0000 |
| h=4 | ARIMAX vs RandomForest | -4.78 | 0.0001 |
| h=3 | RandomForest vs XGBoost | -4.56 | 0.0002 |
| h=2 | ARIMA vs XGBoost | -4.48 | 0.0002 |

## Prediction-interval coverage (nominal 95%)

| Model | Horizon | Coverage | Avg width |
|---|---|---|---|
| ARIMA | h=1 | 79.2% | 2.11 |
| ARIMA | h=2 | 87.0% | 2.265 |
| ARIMA | h=3 | 95.5% | 2.47 |
| ARIMA | h=4 | 90.5% | 2.57 |
| Prophet | h=1 | 75.0% | 1.576 |
| Prophet | h=2 | 73.9% | 1.597 |
| Prophet | h=3 | 72.7% | 1.584 |
| Prophet | h=4 | 61.9% | 1.586 |
